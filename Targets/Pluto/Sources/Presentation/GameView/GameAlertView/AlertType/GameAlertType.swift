...
let page4 = [
    GameAlertType.tutorial(activate: [TutorialView.Activate.changeGreen], bottomString: "지금 초록 버튼을 눌러봐!", topString: "", imageName: "triangle_70_white", isLast: true)
]
...
let page8 = [
    GameAlertType.tutorial(activate: [TutorialView.Activate.changeRed], bottomString: "", topString: "다시 흰색 소행성 궤도에 타기 위해서, 빨간 버튼을 눌러서 색을 원상태로 돌려봐.", imageName: "triangle_70_white", isLast: true)
]
...
let page12 = [
    GameAlertType.tutorial(activate: [], bottomString: "이번에는 흰색 소행성이 나타났어.", topString: "이번에는 흰색 소행성이 나타났어.", imageName: "diamond_70_white", isLast: false),
    GameAlertType.tutorial(activate: [TutorialView.Activate.changeGreen, TutorialView.Activate.changeRed], bottomString: "지금 둘 다 색을 빼서 주인공을 흰색으로 만들어볼까?", topString: "지금 둘 다 색을 빼서 주인공을 흰색으로 만들어볼까?", imageName: "diamond_70_white", isLast: true),
]
